...
class Customer:
    def __init__(self):
        self.custlist=[{'name': 'hong', 'gender': 'M', 'email': 'h@gmail.com', 'birthyear': '2000'},
          {'name': 'kim', 'gender': 'F', 'email': 'k@gmail.com', 'birthyear': '2001'},
          {'name': 'lee', 'gender': 'M', 'email': 'l@gmail.com', 'birthyear': '2002'},
          {'name': 'shin', 'gender': 'F', 'email': 's@gmail.com', 'birthyear': '2003'}]
        self.page=3
        while True:
